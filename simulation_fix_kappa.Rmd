...
## OLS
```{r OLS testing}
configurations <- makeConfiguration_fixKappa(reps = 2e1, m = c(5e0, 5e1), n = c(1.5e2, 1e3) , kappa = 0.1, model = my.ols, link = identity, sigma = 1e1, beta.maker = makeBetasRandom, beta.star.maker = BetaStarIdentity, data.maker = makeRegressionData, truth.fun = truthOLS, name='ols') 
configurations %>% dim
