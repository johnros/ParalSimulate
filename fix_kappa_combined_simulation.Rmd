...
plot.00 <- plotMSEs_fixKappa(MSEs.framed.00, '(a) OLS', legend.position='none', y.lim=.ylim, size=.size, font.size = .font.size)
plot.10 <- plotMSEs_fixKappa(MSEs.framed.10, '(b) Ridge', legend.position='none', y.lim=.ylim, size=.size, font.size = .font.size)
plot.30 <- plotMSEs_fixKappa(MSEs.framed.30, '(c) NLS', legend.position='none', y.lim=.ylim2, size=.size, font.size = .font.size)
plot.40 <- plotMSEs_fixKappa(MSEs.framed.40, '(d) Logistic', legend.position='none', y.lim=.ylim2, size=.size, font.size = .font.size)
