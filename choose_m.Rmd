...
plot.000 <- plotMSEs2(MSEs.framed.000, '(a) OLS MSE', robust=NA, legend.position='right', y.lim=c(-1,50), jitter=0, line=TRUE, fix='Np', center='MSE', bias.fixp = FALSE)
plot.000
...
# load('RData/MSEs_choose_m_ridge.3.RData')
...
plot.0011 <- plotMSEs2(MSEs.framed.001, '(d) Ridge bias', robust=NA, legend.position='right', y.lim=c(-1,10), jitter=0, line=TRUE, fix='Np', center='bias.mean', bias.fixp = TRUE)
plot.0011
```
