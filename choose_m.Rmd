...
plot.0002 <- plotMSEs2(MSEs.framed.000, '(b) OLS MSE- high-dim', robust=NA, legend.position='none', jitter=0, line=TRUE, fix='Np', center='MSE',  lty=.lty, lwd=.lwd, lwd.error=.lwd.error, lty.error = .lty.error, point.size = .point.size, point.size.error = .point.size.error)
plot.0002
...
plot.0003 <- plotMSEs2(MSEs.framed.000, '(c) OLS MSE- second order fixed-p', robust=NA, legend.position='none', jitter=0, line=TRUE, fix='Np', center='MSE', lty=.lty, lwd=.lwd,  lwd.error=.lwd.error, lty.error = .lty.error, point.size = .point.size, point.size.error = .point.size.error)
plot.0003
```
...
grid.arrange(plot.0001, plot.0002, plot.0003, ncol=1)
dev.off()
```
