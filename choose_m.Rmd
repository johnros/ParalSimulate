...
plot.0001 <- plotMSEs2(MSEs.framed.000, '(a) OLS Bias', robust=NA, legend.position='none', jitter=0, line=TRUE, fix='Np', center='bias.mean')
plot.0001
...
plot.0002 <- plotMSEs2(MSEs.framed.000, '(b) OLS MSE- high-dim', robust=NA, legend.position='none', jitter=0, line=TRUE, fix='Np', center='MSE')
plot.0002
...
plot.0003 <- plotMSEs2(MSEs.framed.000, '(c) OLS MSE- second order fixed-p', robust=NA, legend.position='none', jitter=0, line=TRUE, fix='Np', center='MSE')
plot.0003
```
...
plot.0011 <- plotMSEs2(MSEs.framed.001, '(a) Ridge bias', robust=NA, legend.position='none',  jitter=0, line=TRUE, fix='Np', center='bias.mean')
plot.0011

# Second order Ridge MSE
MSEs.framed.001$error.asympt <-  apply(MSEs.framed.001, 1, function(x) 
  ApproxMSE_Ridge_fixp2(n=x[['n']], p=x[['p']], m=x[['m']], lambda = x[['lambda']], beta = x[['beta']], sigma.sq = x[['sigma']]^2))
plot.0012 <- plotMSEs2(MSEs.framed.001, '(b) Ridge second order MSE ', robust=NA, legend.position='none',  jitter=0, line=TRUE, fix='Np', center='MSE')
plot.0012
```
