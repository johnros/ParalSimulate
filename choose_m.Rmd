...
plot.0001 <- plotMSEs2(MSEs.framed.000, '(b) OLS Bias', robust=NA, legend.position='right', y.lim=c(0,0.1), jitter=0, line=TRUE, fix='Np', center='bias.mean', bias.fixp = TRUE)
plot.0001
```
...
plot.0010 <- plotMSEs2(MSEs.framed.001, '(c) Ridge MSE', robust=NA, legend.position='right', y.lim=c(-1,20), jitter=0, line=TRUE, fix='Np', center='MSE')
plot.0010

plot.0011 <- plotMSEs2(MSEs.framed.001, '(d) Ridge bias', robust=NA, legend.position='right', y.lim=c(0,0.1), jitter=0, line=TRUE, fix='Np', center='bias.mean', bias.fixp = TRUE)
plot.0011
```
