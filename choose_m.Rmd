...
plot.000 <- plotMSEs2(MSEs.framed.000, '(a) OLS MSE', robust=NA, legend.position='right', jitter=0, line=TRUE, fix='Np', center='MSE', bias.fixp = FALSE)
plot.000

plot.0001 <- plotMSEs2(MSEs.framed.000, '(b) OLS Bias', robust=NA, legend.position='right', jitter=0, line=TRUE, fix='Np', center='bias.mean', bias.fixp = TRUE)
plot.0001
```
...
MSEs.framed.001<- frameMSEs(MSEs.001, configurations.001, bias.fun.fixp = biasMeanRidge_Fixp)
...
plot.0011 <- plotMSEs2(MSEs.framed.001, '(d) Ridge bias', robust=NA, legend.position='right',  jitter=0, line=TRUE, fix='Np', center='bias.mean', bias.fixp = TRUE)
plot.0011
```
