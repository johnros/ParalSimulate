...
plot.000 <- plotMSEs2(MSEs.framed.000, '(a) OLS MSE', robust=NA, legend.position='right', y.lim=c(-1,10), jitter=0, line=TRUE, fix='Np', center='MSE', bias.fixp = TRUE)
plot.000

plot.0001 <- plotMSEs2(MSEs.framed.000, '(b) OLS Bias', robust=NA, legend.position='right', y.lim=c(0,2), jitter=0, line=TRUE, fix='Np', center='bias')
plot.0001
```
