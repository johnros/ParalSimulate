...
plot.00 <- plotMSEs_fixKappa(MSEs.framed.00, 'OLS', legend.position='right', y.lim=.ylim)
plot.00
```
...
plot.00 <- plotMSEs_fixKappa(MSEs.framed.00, '(a) OLS', legend.position='right', y.lim=.ylim)
plot.10 <- plotMSEs_fixKappa(MSEs.framed.10, '(b) Ridge', legend.position='right', y.lim=.ylim)
plot.30 <- plotMSEs_fixKappa(MSEs.framed.30, '(c) Non-Linear Least Squares', legend.position='right', y.lim=.ylim )
plot.40 <- plotMSEs_fixKappa(MSEs.framed.40, '(d) Logistic', legend.position='right', y.lim=.ylim)
