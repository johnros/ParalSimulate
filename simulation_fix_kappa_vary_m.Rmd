...
MSEs.framed.1 %>% select(n, p, m, lambda, average, truth, kappa)
MSEs.framed.1 %>% filter(lambda==20) %>%
  plotMSEs_fixKappa('test', y.lim=c(0.9,2), legend.position='right')
```
...
- Why less machines is more accurate for Ridge?!?
