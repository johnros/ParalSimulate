...
plot.0 <- plotMSEs(MSEs.framed.0, '(a) OLS', center='median', legend.position='none', y.lim=.ylim, jitter=.jitter, size = .size)

plot.1 <- plotMSEs(MSEs.framed.1, '(b) Ridge', center='median', legend.position='none', y.lim=.ylim, jitter=.jitter, size = .size)

plot.3 <- plotMSEs(MSEs.framed.3, '(c) NLS', center='median', legend.position='none', jitter=.jitter, y.lim=.ylim2, size = .size)

plot.4 <- plotMSEs(MSEs.framed.4, '(d) Logistic', center='median', legend.position='none', jitter=.jitter, y.lim=.ylim2, size = .size)
