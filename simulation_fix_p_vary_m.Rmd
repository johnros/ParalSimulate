...
## Non Linear
[TODO: fix non linear least squares]
```{r nonlinear test}
...
```{r all_plots}
load(file = 'RData/MSEs.0.RData');load(file = 'RData/MSEs.1.RData');load(file = 'RData/MSEs.3.RData');load(file = 'RData/MSEs.4.RData')

plot.0 <- plotMSEs(MSEs.framed.0, '(a) OLS', robust=TRUE, legend.position='none', y.lim=.ylim)
plot.1 <- plotMSEs(MSEs.framed.1, '(b) Ridge', robust=TRUE, legend.position='none', y.lim=.ylim)
plot.3 <- plotMSEs(MSEs.framed.3, '(c) Non-Linear Least Squares', robust=TRUE, legend.position='none', y.lim=.ylim)
plot.4 <- plotMSEs(MSEs.framed.4, '(d) Logistic Regression', robust=TRUE, legend.position='none', y.lim=.ylim)
